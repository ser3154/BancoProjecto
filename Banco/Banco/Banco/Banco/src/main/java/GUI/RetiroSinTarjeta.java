...
public class RetiroSinTarjeta extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        try {
            // Restablecer el temporizador cada vez que se realiza una acción
            timer.restart();
            // Obtener detalles del retiro sin tarjeta del formulario
            double monto = Double.parseDouble(jTextField1.getText());
            int contraseña = Integer.parseInt(jTextField2.getText());

            // Conectar a la base de datos y realizar el retiro sin tarjeta
            ...
            // Crear objeto RetiroSinTarjetaDTO con el constructor
            RetiroSinTarjetaDTO retiroSinTarjetaDTO = new RetiroSinTarjetaDTO(0, contraseña, "En proceso", 0);

            // Realizar el retiro sin tarjeta
            operacionDAO.nuevaRetiroSinTarjeta(retiroSinTarjetaDTO);

            // Notificar al usuario sobre el retiro sin tarjeta exitoso
            JOptionPane.showMessageDialog(this, "Retiro sin tarjeta realizado con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            ...
            // Manejar el caso en que el formato del monto o contraseña no sea válido
            JOptionPane.showMessageDialog(this, "Ingrese un monto y una contraseña válidos.", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (PersisteciaException ex) {
            // Manejar cualquier PersistenciaException
            JOptionPane.showMessageDialog(this, "Error al realizar el retiro sin tarjeta: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
